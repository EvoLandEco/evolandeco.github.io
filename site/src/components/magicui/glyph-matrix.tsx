// Magic UI Glyph Matrix (MIT). See LICENSE-MAGICUI.md.
// Source: https://magicui.design/r/glyph-matrix.json
// Upstream SHA-256: 0c4c11f8a81dab493b0adbf9ed3dd7342c64fd8957926a4e39b31294b1853633
"use client"
...
export function GlyphMatrix({
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      const mutations = Math.floor(total * mutationRate)
    ...
    resize()
    draw()
    if (playing) timer = setInterval(tick, interval)
  ...
  }, [glyphs, cellSize, mutationRate, interval, fadeBottom, playing, color])
