// Magic UI Animated Theme Toggler (MIT). See LICENSE-MAGICUI.md.
// Source: https://magicui.design/r/animated-theme-toggler.json
// Upstream SHA-256: 5d09afdb5968e9f7f3967943c27103d727f264fdd51fa14b10a4b3130a1970a8
"use client"
...
export const AnimatedThemeToggler = ({
  ...
  const toggleTheme = useCallback(() => {
    ...
    if (matchMedia("(prefers-reduced-motion: reduce)").matches || typeof document.startViewTransition !== "function") {
      applyTheme()
      return
    }
